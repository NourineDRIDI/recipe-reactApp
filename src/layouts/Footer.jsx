...
function Footer() {
  ...
  return (
    <footer className="bg-light text-center text-lg-start p-2 d-flex align-items-center justify-content-center position-fixed  w-100 bottom-0  " style={{zIndex:99}} >
